...
CSV_HEADER = [
    ...
    "diff_oi_value_2", "ratio_oi_value_2",
    ...
    try:
        ...
        for r in rows:
            writer.writerow({
                ...
                "total_ce_oi_value_2":      r["total_ce_oi_value_2"],
                "total_pe_oi_value_2":      r["total_pe_oi_value_2"],
                ...
                "diff_oi_value_2":          r["diff_oi_value_2"],
                "ratio_oi_value_2":         r["ratio_oi_value_2"],
                ...
                "fut_total_buy_qty":     r["fut_total_buy_qty"],
                "fut_total_sell_qty":    r["fut_total_sell_qty"],
                "fut_oi_value_ltp":      r["fut_oi_value_ltp"],
                "fut_oi_value_atp":      r["fut_oi_value_atp"],
                "fut_trade_val_ltp":     r["fut_trade_val_ltp"],
                "fut_trade_val_atp":     r["fut_trade_val_atp"],
            })
